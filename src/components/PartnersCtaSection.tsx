          ...
          <div className="bg-gradient-to-r from-red-600 via-orange-500 to-red-600 bg-[length:200%_auto] animate-gradient p-10 md:p-16 rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(220,38,38,0.5)] relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-12 text-white border border-white/20">
            ...
            >
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-bold leading-[1.12] tracking-tight text-white">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-white drop-shadow-sm pr-2">Big Moment</span>
              </h2>
            ...
            >
              <button 
                ...
                className="bg-white text-red-600 px-8 py-5 font-bold uppercase tracking-widest text-sm hover:bg-gray-50 hover:scale-105 transition-all duration-300 rounded-2xl flex items-center justify-center gap-2 shadow-xl group cursor-pointer"
              >
