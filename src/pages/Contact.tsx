                ...
                <AnimatePresence mode="wait">
                  {!submitted ? (
                    ...
                    >
                      ...
                      <button 
                        type="submit"
                        className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#111111] text-white rounded-xl overflow-hidden transition-all duration-300 hover:bg-red-600 hover:shadow-xl self-start"
                      >
                        <span className="relative z-10 font-bold tracking-widest uppercase text-xs">Send Message</span>
                    ...
                    >
                      ...
                      <button 
                        onClick={handleReset}
                        className="px-5 py-2.5 bg-gray-200 hover:bg-gray-300 text-gray-700 rounded-xl font-bold text-xs uppercase tracking-widest transition-colors"
                      >
